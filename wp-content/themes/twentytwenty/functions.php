 ...
 * @since 1.0
 */
function mlt_esc_attr($data) {
    return esc_attr( stripslashes($data) );
}



if( !defined( 'MY_LEARN_THEME_DIR' ) ) {
	define( 'MY_LEARN_THEME_DIR', get_template_directory() ); // Theme dir
}

if( !defined( 'MLT_FAQ_POST_TYPE' ) ) {
    define( 'MLT_FAQ_POST_TYPE', 'mlt_faq' ); // inc dir
}

if( !defined( 'MLT_PAGE_POST_TYPE' ) ) {
    define( 'MLT_PAGE_POST_TYPE', 'page' ); // inc dir
}

if( !defined( 'MLT_META_PREFIX' ) ) {
    define( 'MLT_META_PREFIX', '_mlt_' ); // inc dir
}

require_once MY_LEARN_THEME_DIR . '/includes/init.php';